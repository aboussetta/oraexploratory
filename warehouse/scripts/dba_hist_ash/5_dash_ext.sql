...
--              
-- Usage:       
--     @dash_wait_chains <grouping_cols> <filters> 
--
-- Example:
-- @dash_ext user_id||':'||program2||event2 session_type='FOREGROUND' 
-- @dash_ext user_id||':'||program2||event2||top_level_call_name||sql_opname||p1text||p1 session_type='FOREGROUND' 
-- @dash_ext session_id||'>>'||program2||'>>'||event2||'>>'||sql_id||'>>'||sql_opname||'>>'||p1text||'>>'||p1||'>>'||blocking_session 1=1
--
-- Other:
